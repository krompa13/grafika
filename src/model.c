...
void init_entities(World* world) {
	...
	// Chair
	load_model(&world->chairs[0].model, "data/models/modernchair.obj");
	world->chairs[0].texture = load_texture("data/textures/chair.jpg");
	...
	// Table
	load_model(&world->table1.model, "data/models/desk.obj");
	world->table1.texture = load_texture("data/textures//desk.jpg");
	world->table1.texture = load_texture("data/textures//desk2.jpg");
	world->table1.texture = load_texture("data/textures//desk3.jpg");
